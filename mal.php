...
$sql = "SELECT SUM(jumlah) AS total_jumlah FROM data WHERE status = '1' AND kategori = 'mal'";
...
$sql = "SELECT SUM(total) AS total_beras FROM data WHERE jenis = 'beras' AND status = '1' AND kategori = 'mal'";
...
$sql = "SELECT SUM(total) AS total_uang FROM data WHERE jenis = 'uang' AND status = '1' AND kategori = 'mal'";
...
<table>
    ...
    <?php
    $query = "SELECT * FROM data WHERE status = '1' AND kategori = 'mal' ";
